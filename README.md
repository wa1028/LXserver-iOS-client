...
<h1 align="center">LXMusic iOS 客户端</h1>
...
- **iOS 26 图标 & 应用内切换**：内置 iOS 26 风格主图标与经典图标，设置页支持一键切换，已适配 iOS 26 主屏渲染。
- **歌曲详情 & 跨平台歌手 / 专辑跳转**：歌曲信息页可点击跳转到歌手与专辑。tx / wy在对应平台搜索并自动进入歌手 / 专辑详情页（封面正常加载）；kg / kw / mg本平台不支持歌手 / 专辑检索，自动跳转wy搜索页。
...
- **锁屏 / 控制中心歌词**：采用与 tx、wy一致的「字段复用」方案，锁屏标题显示「歌名 - 歌手」，歌手行显示当前歌词并随播放逐行滚动；设置页「歌词」区新增开关（默认开启）。
